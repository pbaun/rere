  ...
  trait ReqlDatum extends ReqlExpr
    ...
    trait ReqlValue extends ReqlDatum
      ...
      trait ReqlString extends ReqlValue
        trait ReqlUUID extends ReqlString
  ...
  trait ReqlSpecific extends ReqlExpr
    ...
    trait ReqlSequence[+T <: ReqlDatum] extends ReqlSpecific
      ...
      /**
        * Implementations
        */
      trait ReqlTable[T, PK <: PrimaryKey] extends ReqlFiniteStreamLike[ReqlModel[T, PK]] with ReqlShapable[T, PK]

      trait ReqlTableSlice[T, PK <: PrimaryKey] extends ReqlFiniteStreamLike[ReqlModel[T, PK]] with ReqlShapable[T, PK]
      ...
      // SELECTION<ARRAY>
      trait ReqlSelectionOfArray[T, PK <: PrimaryKey] extends ReqlFiniteArrayLike[ReqlModel[T, PK]] with ReqlShapable[T, PK]

      //TODO: selection of stream can be used in .union as stream
      // SELECTION<STREAM>
      trait ReqlSelectionOfStream[T, PK <: PrimaryKey] extends ReqlFiniteStreamLike[ReqlModel[T, PK]] with ReqlShapable[T, PK]
    ...
    // SELECTION<OBJECT>
    trait ReqlSelectionOfObject[T, PK <: PrimaryKey] extends ReqlSpecific with ReqlDatum with ReqlShapable[T, PK]
